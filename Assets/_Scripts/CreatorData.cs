...
public class CreatorData : SingletonMonoBehaviour<CreatorData>
{
	...
	public static readonly string GAME_KEY = "MOT_AUTHOR";
	...
	public void setCreatorData(NetworkConst.author _playerData)
    {
		this.PlayerName = _playerData.name;
		this.Author = _playerData;
		this.CreatorID = _playerData.id;
		
		this.Token = "Bearer " + _playerData.token;
		Debug.Log("Token " + this.Token);
		GameManager.instance.loadAllGroup();
    }
	...
	public CreatorDataMain.SeriesRoles SelectedSeriesRole
    {
        set {
			this._creatorData.selectedSeriesRole = value;
			this.SaveData();
		}
        get { return this._creatorData.selectedSeriesRole; }
	}
	public CreatorDataMain.LessonRoles SelectedLesssonRole
	{
		set
		{
			this._creatorData.selectedLessonRole = value;
			this.SaveData();
		}
		get { return this._creatorData.selectedLessonRole; }
	}
	public CreatorDataMain.RecordRoles SelectedRecordRole
	{
		set
		{
			this._creatorData.selectedRecordRole = value;
			this.SaveData();
		}
		get { return this._creatorData.selectedRecordRole; }
	}
	public CreatorDataMain.MusicRoles SelectedMusicRole
	{
		set
		{
			this._creatorData.selectedMusicRole = value;
			this.SaveData();
		}
		get { return this._creatorData.selectedMusicRole; }
	}
	public CreatorDataMain.LanguageRoles SelectedLanguageRole
	{
		set
		{
			this._creatorData.selectedLanguageRole = value;
			this.SaveData();
		}
		get { return this._creatorData.selectedLanguageRole; }
	}


	public int CreatorID
	{
        set { this._creatorData.creator_id = value;
			this.SaveData();
		}
	...
	public NetworkConst.author Author
    {
        set { this._creatorData.author = value;
			this.SaveData();
		}
        get
        {
			return this._creatorData.author;
        }
    }
...
{
	public enum SeriesRoles {AUTHOR, PUBLISHER, MASTER }
	public enum LessonRoles { AUTHOR, PUBLISHER, MASTER, PRIVATE }
	public enum RecordRoles { EDITOR, PUBLISHER, MASTER, PRIVATE }

	public enum MusicRoles { EDITOR, PUBLISHER, MASTER, PRIVATE }
	public enum LanguageRoles { EDITOR, PUBLISHER, MASTER, PRIVATE }

	public SeriesRoles selectedSeriesRole;
	public LessonRoles selectedLessonRole;
	public RecordRoles selectedRecordRole;
	public MusicRoles selectedMusicRole;
	public LanguageRoles selectedLanguageRole;
